  ...
  return (
    <div className="mais-vendidos">
          ...
          <tbody>
            {produtosData.map((produto) => (
              <tr key={produto.id}>
                ...
                <td className="percentual-cell">
                  <div className="progress-bar-container">
                    <div 
                      className="progress-bar"
                      style={{ width: `${produto.percentual}%` }}
                    >
                      <span className="progress-text">{produto.percentual}%</span>
                    </div>
                  </div>
                </td>
              </tr>
      ...
      <div className="summary-cards">
        ...
        <div className="summary-card card">
          <h4>Ticket Médio</h4>
          <p className="summary-value">R$ 18,34</p>
          <span className="summary-label">por produto</span>
        </div>
      </div>
    </div>
  );
